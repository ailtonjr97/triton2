...
async function docOk(req, res) {
    try {
        ...
        const recipient = req.query.valor <= 40000.00 ? 'aux.adm@fibracem.com' : 'contabil1@fibracem.com';
        const approver = req.query.valor <= 40000.00 ? 'Natali Evelin Peres Pereira' : 'Alex Lemes da Silva';
