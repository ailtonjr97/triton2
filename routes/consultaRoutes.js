...
router.get("/chamados-manut-ind", consultaChamadosManutInd);
router.get("/chamados-status", consultaStatusChamados);
router.get("/chamados-urgencias", consultaUrgenciasChamados);
router.get("/chamados-areas", consultaAreasChamados);
router.get("/chamados-operacoes", consultaOperacoesChamados);
router.get("/chamados-usuarios", consultaAllUsers);
router.get("/chamados-empresas", consultaAllEmpresas);
router.get("/chamados-tipo-manuts", consultaAllTipoManuts);
router.get("/chamados-sub-tipo-manuts", consultaAllSubTipoManuts);
router.get("/chamados-centro-custo", consultaAllCentroCusto);
